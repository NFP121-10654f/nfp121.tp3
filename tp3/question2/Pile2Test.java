...
public class Pile2Test extends junit.framework.TestCase {
    ...
    {
        question2.Pile2 pile21 = new question2.Pile2(5);
        pile21.empiler("rim");
        pile21.empiler(5);
        pile21.empiler(6);
        assertEquals("[6, 5, rim]", pile21.toString());
        assertEquals(false, pile21.estPleine());
        
        question2.Pile2 pile23 = new question2.Pile2(5);
        pile23.empiler("rim");
        pile23.empiler(5);
        pile23.empiler(6);
        assertEquals(true, pile21.equals(pile23));
    }
}
